...
class AgentPathogène {
  public:
    ...
    std::pair<int, int> période_contagieux = {
        0, 2}; // en jours : 1er chiffre apr_ès contagion, second chiffre :
               // après symptomatique
    int nombre_jours_immunité =
        0; // Si différent de zéro, individus développent une immunité pendant
